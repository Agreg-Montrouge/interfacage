...
class AIWindow(QtWidgets.QWidget):
    ...
    def __init__(self, **kwd):
        ...
        start_stop_save_layout = QtWidgets.QHBoxLayout()
        ...
        tmp = pg.LayoutWidget()
        tmp.addWidget(pg.Qt.QtWidgets.QLabel('Sample rate'), col=0)
        ...
        tmp = pg.LayoutWidget()
        tmp.addWidget(pg.Qt.QtWidgets.QLabel('Acquisition duration'), col=0)
